...
const challanSchema = new mongoose.Schema({
    ...
    locationChainage: { type: String, default: '' },
    workFrontLocation: { type: String, default: '' },
    trnCode: { type: String, default: '' },
    sendingCentreCode: { type: String, default: '' },
    ...
    gatePassApprovedBy: { type: String, default: '' },
    consignorTaxNo: { type: String, default: '' },
    vehicleNo: { type: String, default: '' },
    lrNo: { type: String, default: '' },
    freightStatus: { type: String, default: '' },
    receiverName: { type: String, default: '' },
    receiverMobile: { type: String, default: '' },
    mrnNo: { type: String, default: '' },
